...
export default function Contact() {
  return (
    <section className="inline-flex items-center gap-x-8">
      {/* contact details */}
      <div className="flex flex-col gap-y-8">
        <ul>
          <li
            data-aos="fade-right"
            className="text-center font-semibold text-5xl mb-8"
          >
            Contact Details
          </li>
          <li className="inline-flex gap-x-4 items-center">
            <svg
              className="dark:text-[#F5F5F5] text-[#172e31]"
              width="28"
              height="20"
              viewBox="0 0 28 20"
              fill="none"
        ...
        <ul>
          <li className="inline-flex gap-x-4 items-center">
            <svg
              className="mr-2 dark:text-[#F5F5F5] text-[#172e31]"
              width="16"
              height="21"
              viewBox="0 0 16 21"
              fill="none"
...
{
  /* <div className="inline-flex w-full gap-x-8 justify-center mt-8">
        <Link href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=chaton.satria@gmail.com&su=hiring&body=body">
          <a target="_blank">Title</a>
        </Link>
        <p>Email : chaton.satria@gmail.com</p>
      </div> */
}
