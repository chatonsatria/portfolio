export default function Introduction() {
  return (
    <section
      data-aos="fade-right"
      className="flex flex-col lg:flex-row shadow-md rounded-md bg-white dark:bg-[#172e31]"
    >
      {/* designer */}
      <div className="flex flex-col p-8 w-full items-center gap-y-4 text-center">
      ...
      {/* frontend */}
      <div className="flex flex-col p-8 w-full items-center gap-y-4 text-center border-t-2 border-b-2 lg:border-t-0 lg:border-b-0 dark:border-[#13282B] lg:border-l-2 lg:border-r-2 lg:dark:border-[#13282B]">
        <div className="flex w-20 h-20 rounded-full bg-slate-100 dark:bg-[#13282B] text-[#172e31] dark:text-white">
          <svg
            className="w-10 h-10 m-auto"
            width="24"
      ...
      <div className="flex flex-col p-8 w-full items-center gap-y-4 text-center">
        ...
        <p className="h-20">
          I gained my experience through study, and brought that knowledge into
          reality
        </p>
        <ul>
          <li className="font-semibold text-lg text-[#13282B] dark:text-white">
